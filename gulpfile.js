...
var path = {
    ...
    src: { //Пути откуда брать исходники
        pug: 'src/view/**/*.pug', //Синтаксис src/*.html говорит gulp что мы хотим взять все файлы с расширением .html
        js: [
...
gulp.task('html:build', function () {
    return gulp.src(path.src.pug) //Выберем файлы по нужному пути
        .pipe(pug({pretty: true}).on('error', function(){console.log('error')}))
